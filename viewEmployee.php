...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <?php 
            $id = $_GET["id"];
            $sql = $conn->prepare("SELECT * FROM dbo.employee_info WHERE id=:id");
            $sql->execute([
                "id"    => $_GET["id"]
            ]);
            $row = $sql->fetch();
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 mb-1">
                    <a href="editProfileAdmin.php?employeeID=<?php echo $employeeID; ?>"><button class="btn btn-info float-right">Edit Profile</button></a>
                </div>
            </div>
                ...
                <div class="col-md-3 text-center">
                    <div class="card py-4">
                        ...
                        <div class="justify-content-center">
                            <img src="img/undraw_profile_2.svg" class="avatar rounded-circle img-thumbnail" alt="avatar" style="width:200px">
                        </div>
                        ...
                        <p style="margin-bottom:0 !important; font-size:small;"><strong><?php echo $employeeID; ?></strong></p>
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="ifActing" data-id="<?php echo $employeeID; ?>" <?php echo $acting; ?>>
                            <label class="custom-control-label" for="ifActing">Acting in this Position?</label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="background" class="tab-pane fade">
                            ...
                            <?php 
                                ...
                                $sql = $conn->prepare("SELECT * FROM dbo.family_background WHERE employeeID=:employeeID");
                                $sql->execute([
                                    "employeeID" => $employeeID
                                ]);
                                $count = 0;
                            ...
                            <?php 
                                ...
                                $sql = $conn->prepare("SELECT * FROM dbo.beneficiaries WHERE employeeID=:employeeID");
                                $sql->execute([
                                    "employeeID" => $employeeID
                                ]);
                                $count = 0;
                        ...
                        <div id="hobskill" class="tab-pane fade">
                            ...
                            <?php 
                                ...
                                $sql = $conn->prepare("SELECT * FROM dbo.hobbies WHERE employeeID=:employeeID");
                                $sql->execute([
                                    "employeeID" => $employeeID
                                ]);
                                $count = 0;
                            ...
                            <?php 
                                ...
                                $sql = $conn->prepare("SELECT * FROM dbo.skills WHERE employeeID=:employeeID");
                                $sql->execute([
                                    "employeeID" => $employeeID
                                ]);
                                $count = 0;
                        ...
                        <div id="educaward" class="tab-pane fade">
                            ...
                            <?php 
                                ...
                                $sql = $conn->prepare("SELECT * FROM dbo.education WHERE employeeID=:employeeID");
                                $sql->execute([
                                    "employeeID" => $employeeID
                                ]);
                                $count = 0;
                            ...
                            <?php 
                                ...
                                $sql = $conn->prepare("SELECT * FROM dbo.exams WHERE employeeID=:employeeID");
                                $sql->execute([
                                    "employeeID" => $employeeID
                                ]);
                                $count = 0;
                            ...
                            <?php 
                                ...
                                $sql = $conn->prepare("SELECT * FROM dbo.awards WHERE employeeID=:employeeID");
                                $sql->execute([
                                    "employeeID" => $employeeID
                                ]);
                                $count = 0;
                        ...
                        <div id="exptraining" class="tab-pane fade">
                            ...
                            <?php 
                                ...
                                $sql = $conn->prepare("SELECT * FROM dbo.experience WHERE employeeID=:employeeID");
                                $sql->execute([
                                    "employeeID" => $employeeID
                                ]);
                                $count = 0;
                            ...
                            <?php 
                                ...
                                $sql = $conn->prepare("SELECT * FROM dbo.trainings WHERE employeeID=:employeeID");
                                $sql->execute([
                                    "employeeID" => $employeeID
                                ]);
                                $count = 0;
                            ...
                            <?php 
                                ...
                                $sql = $conn->prepare("SELECT * FROM dbo.organizations WHERE employeeID=:employeeID");
                                $sql->execute([
                                    "employeeID" => $employeeID
                                ]);
                                $count = 0;
